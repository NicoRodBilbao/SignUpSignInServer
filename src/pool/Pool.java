...
public class Pool {
    ...
    /**
     * Create the Pool object specifying the initial number of connections.
     *
	...
	* @param n number of initial connections
    ...
    /**
     * Returns a connection to the database, if there aren't any free
     * connections it creates one, the maximum amount of connections there can
     * be is defined by the CONNECTION_LIMIT property.
     *
    ...
    /**
     * Receives a connection that's not being used anymore and stores it to be
     * used later.
     *
     * @param con
     * @throws exceptions.ServerException
    ...
    /**
     * Removes all the closed connections from both free and used collections.
     */
